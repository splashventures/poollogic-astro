...
export const metadata: Metadata = {
  title: 'Privacy Policy | PoolLogic Pool Service',
  description: 'Privacy policy for PoolLogic Pool Service. Learn how we collect, use, and protect your personal information.',
};
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-lg max-w-none text-gray-600">
            ...
            <ul>
              ...
              <li>Property address where services will be performed</li>
              <li>Pool and equipment information relevant to providing services</li>
            ...
            <ul>
              ...
              <li>Send you service-related communications (appointment reminders, service reports)</li>
